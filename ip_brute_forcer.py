...
# SSE Program
# Attack: IP Brute Forcer
# Date: February 1, 2016
# Description: Some networks dont deliver you an IP via DHP and sometimes
# there is no client to find out the IP frame by looking at its config.  In
# such a case, one could brute force an IP
